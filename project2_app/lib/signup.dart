...
class _SignUpState extends State<SignUp> {
  ...
  var _phoneNumber = '';
  var _password = '';
  var _status = 'lecture'; // Default status is set to 'lecture'
  ...
  void _signup() async {
    if (_formKey.currentState!.validate()) {
        ...
        body: json.encode(
          {
            ...
            'password': _password,
            'status': _status, // Include the selected status
          },
        ),
      );
      ...
      if (response.statusCode == 200) {
        ...
        // Handle error case, show an error message or take appropriate action
        // For now, let's just print the error response
